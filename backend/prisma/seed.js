  ...
  const demoJobs = [
    {
      ...
      description: 'Build and maintain modern hiring platform features across a Next.js frontend and NestJS backend. You will work with PostgreSQL, Redis queues, and API integrations.',
      location: 'Addis Ababa, Ethiopia',
      type: 'FULL_TIME',
    ...
    },
    {
      ...
      description: 'Plan campaigns, manage social channels, and improve job seeker acquisition through data-driven marketing.',
      location: 'Addis Ababa, Ethiopia',
      type: 'HYBRID',
    ...
    },
    {
      ...
      description: 'Support employers and candidates, resolve account issues, and maintain a high-quality user experience.',
      location: 'Addis Ababa, Ethiopia',
      type: 'FULL_TIME',
    ...
    },
    {
      ...
      description: 'Design clean job search and employer dashboard experiences. Portfolio with web or mobile product examples required.',
      location: 'Remote',
      type: 'REMOTE',
    ...
    },
    {
      ...
      description: 'Own monthly reporting, general ledger review, and finance operations for a growing service company.',
      location: 'Addis Ababa, Ethiopia',
      type: 'FULL_TIME',
